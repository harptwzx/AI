...
用法:
    ...
    python process_data.py --sample 0.5     # 50% 数据
    python process_data.py --sample 0.1     # 10% 数据（推荐快速测试）
    python process_data.py --max-lines 5000 # 最多 5000 句（最小化）
    python process_data.py --sample 0.05 --max-lines 2000  # 超小数据集
"""
