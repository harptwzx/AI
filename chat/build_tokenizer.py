...
Tokenizer 训练脚本
==================
默认使用 WordTokenizer（瞬间完成）

用法:
    python build_tokenizer.py                    # 默认 WordTokenizer，全部数据
    python build_tokenizer.py --sample 0.1     # 10% 数据
    python build_tokenizer.py --sample 0.05 --max-lines 2000  # 超小数据集
...
def train_word_tokenizer(texts: list, min_freq: int = 3, save_dir: str = "./data/tokenizer"):
...
def main():
    ...
    parser.add_argument("--min-freq", type=int, default=3, help="WordTokenizer 单词最小频率")
    parser.add_argument("--sample", type=float, default=1.0, help="数据采样比例 (0.1=10%)")
